...
class OutdatedSubState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var kadeLogo:FlxSprite = new FlxSprite(FlxG.width, 0).loadGraphic(Paths.image('GlitchEngineLogo'));
		...
		var txt:FlxText = new FlxText(0, 0, FlxG.width,
			"Your Glitch Engine is outdated!\nYour version is: "
			+ MainMenuState.kadeEngineVer
			+ "\nwhile the updated version is " + needVer + "."
			+ "\n\nWhat's new:\n\n"
			+ currChanges
			+ "\n& more changes and bugfixes in the full changelog"
			+ "\n\nPress Shift to view the full changelog and update\nor ENTER to ignore this",
			32);
