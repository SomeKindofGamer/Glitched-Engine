...
class KeyBindMenu extends FlxSubState
{
	...
	{	
		...
		keyTextDisplay.setFormat("VCR OSD Mono", 54, FlxColor.WHITE, FlxTextAlign.CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		infoText.setFormat("VCR OSD Mono", 32, FlxColor.WHITE, FlxTextAlign.CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
